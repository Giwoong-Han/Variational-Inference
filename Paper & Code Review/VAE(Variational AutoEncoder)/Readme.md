...
> * 해당 한계점을 보완하기위해 Latent Space의 각 원소간의 관계를 자동으로 학습하는 Autoregression 방법론이 등장하였습니다.
>> - VQ(Vector Quantization)-VAE를 소개하는 Neural Discrete Representation Learning (ICLR 2020)
